"""
Django settings for assistantApp project.
...
SECRET_KEY = 'django-insecure-kf=o=my=09lde-4%%t$w)!c=j6a8i0py5#t_fxf=*k*)p=(g_#'
...
ROOT_URLCONF = 'assistantApp.urls'
...
WSGI_APPLICATION = 'assistantApp.wsgi.application'
